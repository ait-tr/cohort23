...
public class UsersController implements UsersApi {
    ...
    @Override
    public ResponseEntity<ArticlesDto> getPublishedArticlesOfUser(Integer pageNumber, Long userId) {
        return ResponseEntity
                .ok(usersService.getPublishedArticlesArticlesOfUser(pageNumber, userId));
    }
}
