...
public interface UsersApi {
    ...
    ResponseEntity<UsersDto> getAllUsers(
            ...
            @RequestParam(value = "articles", required = false) String articlesState);
    ...
    @GetMapping("/{user-id}/articles/published")
    ResponseEntity<ArticlesDto> getPublishedArticlesOfUser(@Parameter(description = "Номер страницы", example = "1")
                                                           @RequestParam(value = "page") Integer page,
                                                           @PathVariable("user-id") Long userId);
}
